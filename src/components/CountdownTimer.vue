<template>
 <section class="py-20 md:py-32 bg-primary text-on-primary rounded-lg relative text-on-primary overflow-hidden" ref="sectionRef">
 <!-- Decorative background elements -->
 <div class="absolute inset-0 opacity-10">
 <div class="absolute top-0 left-10 w-[300px] h-[300px] bg-primary rounded-full blur-[100px]"></div>
 <div class="absolute bottom-0 right-10 w-[200px] h-[200px] glass-panel rounded-full blur-[80px]"></div>
 </div>
 ...
 <div class="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full border border-primary/30 flex items-center justify-center glass-panel backdrop-blur-sm mb-4">
 <span class="text-2xl md:text-4xl lg:text-5xl font-serif">{{ days }}</span>
 </div>
 ...
 <div class="flex flex-col items-center">
 <div class="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full border border-primary/30 flex items-center justify-center glass-panel backdrop-blur-sm mb-4">
 <span class="text-2xl md:text-4xl lg:text-5xl font-serif">{{ hours }}</span>
 </div>
 ...
 <div class="flex flex-col items-center">
 <div class="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full border border-primary/30 flex items-center justify-center glass-panel backdrop-blur-sm mb-4">
 <span class="text-2xl md:text-4xl lg:text-5xl font-serif">{{ minutes }}</span>
 </div>
 ...
 <div class="flex flex-col items-center">
 <div class="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full border border-primary/30 flex items-center justify-center glass-panel backdrop-blur-sm mb-4">
 <span class="text-2xl md:text-4xl lg:text-5xl font-serif">{{ seconds }}</span>
 </div>
 <span class="text-[10px] md:text-xs tracking-[0.2em] uppercase text-on-primary/60">Seconds</span>
 </div>
