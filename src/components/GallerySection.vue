<template>
  <section class="py-24 bg-mulyo-light relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
      <!-- Section Header -->
      <div class="text-center mb-16 space-y-4">
        <h2 class="text-mulyo-gold text-sm tracking-[0.4em] uppercase font-sans">Our Moments</h2>
        <h3 class="text-4xl md:text-5xl font-playfair text-mulyo-charcoal">Photo Gallery</h3>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4" ref="galleryRef">
        ...
        >
          <div class="w-full h-full overflow-hidden rounded shadow-lg group cursor-pointer aspect-[3/4]">
            <img 
              :src="image" 
              alt="Wedding Moment" 
              ...
              loading="lazy"
            />
            <div class="absolute inset-0 bg-mulyo-charcoal/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
    ...
    <div class="absolute -top-24 -left-24 w-96 h-96 bg-mulyo-gold/5 rounded-full blur-[100px]"></div>
    <div class="absolute -bottom-24 -right-24 w-96 h-96 bg-mulyo-gold/5 rounded-full blur-[100px]"></div>
  </section>
</template>
