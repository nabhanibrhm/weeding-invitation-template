<template>
 ...
 <div class="inline-block p-3 rounded-full bg-primary/10 text-black mb-4">
 ...
 <div class="text-xs tracking-[0.3em] uppercase text-black/70 mb-2">{{ account.bankName }}</div>
 ...
 class="px-6 py-2 rounded-full border border-primary/30 text-black text-xs uppercase tracking-widest hover:bg-primary-container hover:text-on-primary-container hover:text-on-surface transition-all duration-300"
 >
