<template>
  <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden floating-container">
    <div
      v-for="n in 25"
      :key="n"
      class="particle absolute rounded-full bg-gradient-to-br from-mulyo-gold via-mulyo-gold/70 to-transparent backdrop-blur-sm shadow-[0_0_8px_rgba(212,175,55,0.4)]"
